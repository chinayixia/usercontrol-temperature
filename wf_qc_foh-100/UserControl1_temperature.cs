...
namespace wf_qc_foh_100
{
    ...
    public partial class UserControl1_temperature : UserControl
    {
        #region 属性与构造函数
        ...
        private Color backGroundColor = Color.WhiteSmoke;//Color.AliceBlue;
        ...
        public UserControl1_temperature()
        {
            InitializeComponent();
        }
        #endregion
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            //画刻度
            int s_s_x_1 = padding + r - 10;   //int s_s_x_1 = padding + r - 20;
            int s_s_x_2 = width - padding - r + 10;   // int s_s_x_2 = width - padding - r + 20;
            int s_s_y = padding + r + 4;
            int total = this.maxValue - this.minValue;
            int scale_width = 3;//刻度宽度int scale_width = 5;
            ...
            string cur = string.Format("{0}℃", this.curValue);
